...
<body>
	...
	<div class="filter" style="float:left;display:inline;border:none"><%@include file="../content/categoryfilter.jsp"%></div>
	<div class="content" style="float:right;display:inline;border:none">
		<s:if test="%{#session.selcategory==null}">
			<span class="error">Please Select a Sub Category from Category Filter</span>
		</s:if>
		<s:else><%@include file="../content/rules/editCategorytab.jsp"%></s:else>
	</div>
